...
ui <- fluidPage(
  ...
  HTML(paste0("This webpage applies the quantile estimation (QE) method and the Box-Cox (BC) method of ", tags$a(href="https://doi.org/10.1177/0962280219889080", "McGrath et al. (2020)"), " as well as the Method for Unknown Non-Normal Distributions (MLN) approach of ", tags$a(href="https://doi.org/10.1177/09622802211047348", "Cai et al. (2021)"), " to estimate the sample mean and standard deviation from a study that presents one of the following sets of summary statistics:")),
  ...
  HTML(paste0("The standard error (SE) of the mean is estimated by the parametric bootstrap approach of ", tags$a(href="https://doi.org/10.1177/09622802221139233", "McGrath et al. (2023)"), ".")),
  br(), br(), 
  ...
  br(),
  br(),
  HTML(paste0("Note that the R package ", tags$a(href="https://CRAN.R-project.org/package=metamedian", "metamedian"), " can apply these methods (as well as several others) to perform a meta-analysis. See ", tags$a(href="https://doi.org/10.1002/jrsm.1686", "McGrath et al. (in press)"),  " for a guide on using the metamedian package.")), 
  br(), 
  br(),
  ...
  HTML(paste0(tags$a(href="https://doi.org/10.1177/09622802211047348", "https://doi.org/10.1177/09622802211047348"))), 
  br(), br(),
  ...
  HTML(paste0(tags$a(href="https://doi.org/10.1177/0962280219889080", "https://doi.org/10.1177/0962280219889080"))), 
  br(), br(),
  print("McGrath S., Katzenschlager S., Zimmer A.J., Seitel A., Steele R., and Benedetti A. (2023). Standard error estimation in meta-analysis of studies reporting medians. Statistical Methods in Medical Research, 32(2), 373-388."), 
  HTML(paste0(tags$a(href="https://doi.org/10.1177/09622802221139233", "https://doi.org/10.1177/09622802221139233"))), 
  br(), br(),
  print("McGrath S., Zhao X., Ozturk O., Katzenschlager S., Steele R., and Benedetti A. (in press). metamedian: An R package for meta-analyzing studies reporting medians. Research Synthesis Methods."), 
  HTML(paste0(tags$a(href="https://doi.org/10.1002/jrsm.1686", "https://doi.org/10.1002/jrsm.1686"))), 
)
